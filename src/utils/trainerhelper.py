...
@torch.no_grad()
def calculate_validation_loss(model: 'MultiMemoryTransformer', val_loader: DataLoader, criterion: nn.Module,
    ...
    for batch in val_loader:
        ...
        memory_padding_masks = [s.to(device) for s in batch.get('memory_padding_masks', [])]
